...
import { faEye, faEyeSlash, faDiceD6, faPager, faInfoCircle, faBars, faTimes } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <>
      ...
      <FontAwesomeIcon
        ...
        className={`hamburger-icon ${isSidebarOpen ? 'hamburger-icon-open' : ''}`} // Add a new class when sidebar is open
